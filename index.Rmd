...
A total of 2,640 billionaires worldwide are represented in this data. The data file for this study is `Billionaires Statistics Dataset.csv` and contains the following variables:
