...
Specifically, I am interested in understanding what factors differentiate the "nouveau riche" from billionaires who inherited their wealth. 
My research question is: to what extent can self-made status explain whether someone becomes a billionaire? Are there more powerful explanatory variables related to personal characteristics of the billionaire, like their gender or age? Or are their more circumstantial characteristics that can account for their wealth, like the industry they're in or their country of origin? How about something even more removed, like the tax rate or education rate of their country of origin?
I hypothesize that circumstances of birth (e.g. someone's gender, or whether they inherited their wealth) will better explain who becomes a billionaire than more "distant" variables, like their country of origin's tax rate or education rate. 
...
```
It's important to note that this dataset is current as of 2022, not 2023.
...
In addition, I merged the dataset 'countrycode' so that I could create a variable representing the continent of the billionaire ('continent').
```{r, echo = FALSE}
...
billionaires_aggregate_wealth
```
The aggregate wealth of the billionaires in the dataset is $12,206,800,000,000: a whopping $12.2 trillion USD. 
...
ggplot(data = billionaires,
 ...
 # Adding a vertical line at Elon Musk's net worth ($180 billion!)
  geom_vline(xintercept = 180000, 
           linetype = "dashed", color = "lightblue2", 
           size = 1, alpha = 0.7) +
  # Adding a text label for Elon Musk's net worth
  annotate("text", x = 180000, y = 30, 
           label = "Elon Musk's Net Worth ($180b)", color = "lightblue2", 
           angle = 90, vjust = -0.5, hjust = -0.65) +
  ...
  annotate("text", x = 24400, y = 30, 
           label = "MacKenzie Scott's Net Worth ($24.4b)", color = "lightblue2", 
           angle = 90, vjust = -0.5, hjust = -0.35) +
  ...
  annotate("text", x = 114000, y = 30, 
           label = "Jeff Bezos's Net Worth ($114b)", color = "lightblue2", 
           angle = 90, vjust = -0.5, hjust = -0.63) +
   # Adding a vertical line at the median
  geom_vline(xintercept = median_finalWorth, 
             linetype = "dashed", color = "tan2", 
             size = 1, alpha = 0.7) +
  # Adding a text label for the median
  annotate("text", x = median_finalWorth, y = 30, 
           label = "Median", color = "tan2", 
           angle = 90, vjust = -0.5, hjust = -2.75)
```
